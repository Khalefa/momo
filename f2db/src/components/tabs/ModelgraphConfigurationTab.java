 ...
 *
 */
public class ModelgraphConfigurationTab extends AbstractComponent implements GenericModelChangeListener {
     ...
     */
    public ModelgraphConfigurationTab(Composite parent, int style) {
        super(parent, style);
        this.parent = parent;
        loadConfiguration();
    }
