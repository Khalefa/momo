...
extern Datum initMediumForecastModel (PG_FUNCTION_ARGS);
extern Datum loadMediumModelParameters (PG_FUNCTION_ARGS);
extern Datum processMediumForecastModel (PG_FUNCTION_ARGS);
extern Datum finalizeMediumForecastModel (PG_FUNCTION_ARGS);
extern Datum storeMediumModelParameters (PG_FUNCTION_ARGS);
extern Datum getNextMediumValue (PG_FUNCTION_ARGS);
extern Datum incrementalUpdateMediumModel (PG_FUNCTION_ARGS);
extern Datum initLinRegModel (PG_FUNCTION_ARGS);
extern Datum loadLinRegModelParameters (PG_FUNCTION_ARGS);
extern Datum processLinRegModel (PG_FUNCTION_ARGS);
extern Datum finalizeLinRegModel (PG_FUNCTION_ARGS);
extern Datum storeLinRegModelParameters (PG_FUNCTION_ARGS);
extern Datum getNextLinRegValue (PG_FUNCTION_ARGS);
extern Datum incrementalUpdateLinRegModel (PG_FUNCTION_ARGS);
extern Datum initRModel (PG_FUNCTION_ARGS);
extern Datum loadRModelParameters (PG_FUNCTION_ARGS);
extern Datum processRModel (PG_FUNCTION_ARGS);
extern Datum finalizeRModel (PG_FUNCTION_ARGS);
extern Datum storeRModelParameters (PG_FUNCTION_ARGS);
extern Datum getNextRValue (PG_FUNCTION_ARGS);
extern Datum incrementalUpdateRModel (PG_FUNCTION_ARGS);
extern Datum initarModel (PG_FUNCTION_ARGS);
extern Datum loadarModelParameters (PG_FUNCTION_ARGS);
extern Datum processarModel (PG_FUNCTION_ARGS);
extern Datum finalizearModel (PG_FUNCTION_ARGS);
extern Datum storearModelParameters (PG_FUNCTION_ARGS);
extern Datum getNextarmodelValue (PG_FUNCTION_ARGS);
extern Datum incrementalUpdatearModel (PG_FUNCTION_ARGS);
extern Datum incrementalUpdatearModel1 (PG_FUNCTION_ARGS);
extern Datum incrementalUpdatearModel2 (PG_FUNCTION_ARGS);
extern Datum reestimateArModelParameters (PG_FUNCTION_ARGS);
extern Datum inithwModel (PG_FUNCTION_ARGS);
extern Datum loadhwModelParameters (PG_FUNCTION_ARGS);
extern Datum processhwModel (PG_FUNCTION_ARGS);
extern Datum finalizehwModel (PG_FUNCTION_ARGS);
extern Datum storehwModelParameters (PG_FUNCTION_ARGS);
extern Datum getNexthwmodelValue (PG_FUNCTION_ARGS);
extern Datum incrementalUpdatehwModel1 (PG_FUNCTION_ARGS);
extern Datum incrementalUpdatehwModel2 (PG_FUNCTION_ARGS);
extern Datum reestimateHwModelParameters (PG_FUNCTION_ARGS);
...
const FmgrBuiltin fmgr_builtins[] = {
  ...
  { 60000, "initMediumForecastModel", 0, true, false, initMediumForecastModel },
  { 60001, "loadMediumModelParameters", 2, true, false, loadMediumModelParameters },
  { 60002, "processMediumForecastModel", 2, true, false, processMediumForecastModel },
  { 60003, "finalizeMediumForecastModel", 1, true, false, finalizeMediumForecastModel },
  { 60004, "storeMediumModelParameters", 2, true, false, storeMediumModelParameters },
  { 60005, "getNextMediumValue", 2, true, false, getNextMediumValue },
  { 60006, "incrementalUpdateMediumModel", 2, true, false, incrementalUpdateMediumModel },
  { 60010, "initLinRegModel", 0, true, false, initLinRegModel },
  { 60011, "loadLinRegModelParameters", 2, true, false, loadLinRegModelParameters },
  { 60012, "processLinRegModel", 2, true, false, processLinRegModel },
  { 60013, "finalizeLinRegModel", 1, true, false, finalizeLinRegModel },
  { 60014, "storeLinRegModelParameters", 2, true, false, storeLinRegModelParameters },
  { 60015, "getNextLinRegValue", 2, true, false, getNextLinRegValue },
  { 60016, "incrementalUpdateLinRegModel", 2, true, false, incrementalUpdateLinRegModel },
  { 60020, "initRModel", 0, true, false, initRModel },
  { 60021, "loadRModelParameters", 2, true, false, loadRModelParameters },
  { 60022, "processRModel", 2, true, false, processRModel },
  { 60023, "finalizeRModel", 1, true, false, finalizeRModel },
  { 60024, "storeRModelParameters", 2, true, false, storeRModelParameters },
  { 60025, "getNextRValue", 2, true, false, getNextRValue },
  { 60026, "incrementalUpdateRModel", 2, true, false, incrementalUpdateRModel },
  { 60034, "initarModel", 0, true, false, initarModel },
  { 60035, "loadarModelParameters", 2, true, false, loadarModelParameters },
  { 60036, "processarModel", 2, true, false, processarModel },
  { 60037, "finalizearModel", 1, true, false, finalizearModel },
  { 60038, "storearModelParameters", 2, true, false, storearModelParameters },
  { 60039, "getNextarmodelValue", 2, true, false, getNextarmodelValue },
  { 60040, "incrementalUpdatearModel", 2, true, false, incrementalUpdatearModel },
  { 60041, "incrementalUpdatearModel1", 2, true, false, incrementalUpdatearModel1 },
  { 60042, "incrementalUpdatearModel2", 2, true, false, incrementalUpdatearModel2 },
  { 60043, "reestimateArModelParameters", 2, true, false, reestimateArModelParameters },
  { 60044, "inithwModel", 0, true, false, inithwModel },
  { 60045, "loadhwModelParameters", 2, true, false, loadhwModelParameters },
  { 60046, "processhwModel", 2, true, false, processhwModel },
  { 60047, "finalizehwModel", 1, true, false, finalizehwModel },
  { 60048, "storehwModelParameters", 2, true, false, storehwModelParameters },
  { 60049, "getNexthwmodelValue", 2, true, false, getNexthwmodelValue },
  { 60050, "incrementalUpdatehwModel1", 2, true, false, incrementalUpdatehwModel1 },
  { 60051, "incrementalUpdatehwModel1", 2, true, false, incrementalUpdatehwModel1 },
  { 60052, "incrementalUpdatehwModel2", 2, true, false, incrementalUpdatehwModel2 },
  { 60053, "reestimateHwModelParameters", 2, true, false, reestimateHwModelParameters },
