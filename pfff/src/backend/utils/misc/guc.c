...
static const struct config_enum_entry mmstrat_options[] = {
	{"first",0},
	{"last",1},
	{"average",2},
	{"sum",3},
...
static const struct config_enum_entry optim_method_options[] = {
	{"DIRECT-L",0},
	{"CRS",1},
	{"MLSL",2},
	{"ISRES",3},
...
static const struct config_enum_entry modelgraph_with_ids_options[] = {
	{"OFF",0},
	{"ON",1},
	{NULL, 0, false}
};
...
static struct config_bool ConfigureNamesBool[] =
{
	...
	},
	{
		...
		{
		{"allow_ModelGraph_create", PGC_USERSET, COMPAT_OPTIONS_PREVIOUS,
			gettext_noop("Allow the Modelgraph to create missing Models"),
		},
		&allow_ModelGraph_create,
		true, NULL, NULL
	},
	{
...
{
	{
		{"printDebug", PGC_USERSET, DEVELOPER_OPTIONS,
				gettext_noop("Da very special secrete DB-flag."),
		},
		&printDbg,
		0, 0, 1, NULL, NULL
	},
	{
		{"sdf", PGC_USERSET, DEVELOPER_OPTIONS,
			gettext_noop("Da very special secrete DB-flag."),
		},
		&sdf,
	...
	{
		{"optim_term_maxeval", PGC_SUSET, LOGGING_WHEN,
				gettext_noop("Sets the max Evaluation termination criterium"),
...
static struct config_real ConfigureNamesReal[] =
{
	...
	{
		{"alpha", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Sets the alpha parameter for the Greey-Algorithm. Default 0.5."),
			NULL
		},
		&alpha,
		0.5, 0, 1.0, NULL, NULL
	...
	{
		{"trainingDataPercentage", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Sets the percentage of the timeseries used for "),
			NULL
		},
		&trainingDataPercentage,//XXX:CHANGE FOE MEASURING
		0.9, 0.5, 1.0, NULL, NULL
	},
	{
		{"optim_term_maxtime", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Sets the max optimization time. Set to 0 to disable"),
			NULL
		},
		&optim_term_maxtime,
		1.0, 0, DBL_MAX, NULL, NULL
	},
	{
		{"optim_term_ftol_abs", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Sets the absolute f Tolerance termination criterium. Set to 0 to disable"),
			NULL
		},
		&optim_term_ftol_abs,
		0.0, 0, DBL_MAX, NULL, NULL
	},
	{
		{"optim_term_ftol_rel", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Sets the relative f Tolerance termination criterium. Set to 0 to disable"),
			NULL
		},
		&optim_term_ftol_rel,
		0.0, 0, DBL_MAX, NULL, NULL
	...
	{
		{"optim_term_xtol_rel", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Sets the relative x Tolerance termination criterium. Set to 0 to disable"),
			NULL
		},
		&optim_term_xtol_rel,
		0.0, 0, DBL_MAX, NULL, NULL
	...
	{
		{"optim_term_xtol_abs", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Sets the absolute x Tolerance termination criterium. Set to 0 to disable"),
			NULL
		},
		&optim_term_xtol_abs,
		0.0, 0, DBL_MAX, NULL, NULL
...
static struct config_enum ConfigureNamesEnum[] =
{
	...
	{
		{"mmstrat", PGC_SUSET, LOGGING_WHEN,
			gettext_noop("Sets the method how to chose a model."),
		},
		&mmstrat,
		0, mmstrat_options, NULL, NULL
	},
	{
		{"optim_method_general", PGC_SUSET, LOGGING_WHEN,
			gettext_noop("Sets the method how to optimize the model."),
		},
		&optim_method_general,
		6, optim_method_options, NULL, NULL
	},
	{
		{"modelgraph_with_ids", PGC_SUSET, LOGGING_WHEN,
			gettext_noop("Should the Modelgraph contain any unique ids."),
		},
		&modelgraph_with_ids,
		0, modelgraph_with_ids_options, NULL, NULL
	},
	{
		{"optim_method_local", PGC_SUSET, LOGGING_WHEN,
			gettext_noop("Sets the local method how to optimize the model."),
		},
		&optim_method_local,
		6, optim_method_options, NULL, NULL
	},	
