			   ...
			   char *completionTag)
{
	...
	switch (nodeTag(parsetree))
	{
		...
		case T_PrintStmt:
			PrintOutput((PrintStmt *) parsetree, queryString, params, dest);
			break;
		
		case T_StoreStmt:
			StoreModelGraph((StoreStmt *) parsetree);
			break;
			
		case T_RestoreStmt:
			RestoreModelGraph((RestoreStmt *) parsetree);
			break;
		...
		case T_CreateModelStmt:
			transformCreateModelStmt((CreateModelStmt *)parsetree,queryString);

			CreateModel((CreateModelStmt *) parsetree,queryString,dest,completionTag);
			break;

		case T_CreateModelGraphStmt:
			transformCreateModelGraphStmt((CreateModelGraphStmt *)parsetree, queryString, completionTag);

			CreateModelGraph((CreateModelGraphStmt *)parsetree);
			break;
		...
		case T_CreateDisAggSchemeStmt:
			transformCreateDisAggSchemeStmt((CreateDisAggSchemeStmt *)parsetree, queryString, completionTag);

			CreateDisaggScheme((CreateDisAggSchemeStmt *)parsetree, 0);
			break;

		case T_FillModelGraphStmt:
			transformFillModelGraphStmt((FillModelGraphStmt *)parsetree, queryString, completionTag);

			FillModelGraph((FillModelGraphStmt *)parsetree);
			break;
		case T_ReestimateModelGraphModelsStmt:
			ReestimateAllModelGraphModels();
			break;
...
CreateCommandTag(Node *parsetree)
{
	...
	switch (nodeTag(parsetree))
	{
		...
		case T_CreateModelGraphStmt:
			tag = "CREATE MODELGRAPH";
			break;
		case T_DropModelGraphStmt:
			tag= "DROP MODELGRAPH";
			break;
		case T_CreateDisAggSchemeStmt:
			tag = "CREATE DISAGGSCHEME";
			break;
		...
		case T_ReestimateModelGraphModelsStmt:
			tag = "ReestimateModelGraphModelsStmt";
			break;
