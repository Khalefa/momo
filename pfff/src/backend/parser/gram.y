...
%type <node>	stmt schema_stmt
		...
		CreateOpFamilyStmt AlterOpFamilyStmt CreatePLangStmt CreateModelStmt
		CreateSchemaStmt CreateSeqStmt CreateStmt CreateTableSpaceStmt
		CreateFdwStmt CreateForeignServerStmt CreateAssertStmt CreateTrigStmt
		CreateUserStmt CreateUserMappingStmt CreateRoleStmt
		CreatedbStmt DeclareCursorStmt DefineStmt DeleteStmt DisAggStmt DiscardStmt
		...
		DeallocateStmt PrepareStmt ExecuteStmt PrintStmt StoreStmt RestoreStmt
		DropOwnedStmt ReassignOwnedStmt
		AlterTSConfigurationStmt AlterTSDictionaryStmt CreateModelGraphStmt DropModelGraphStmt
		CreateDisAggSchemeStmt FillModelGraphStmt ReestimateModelGraphModelsStmt
...
%type <list>	stmtblock stmtmulti
				...
				relation_expr_list columnref_list
...
%type <node>	forecast_clause opt_algorithm_clause opt_forecast_clause opt_on_clause
				opt_a_expr
 				...
 				CREATE MODEL ColId FOR FORECAST OF columnref ON columnref AlgorithmClause opt_storage_clause
 					{
						...
						insertSelectOptions(n2, NULL, NIL, NULL, NULL, NULL, (Node *)n1, NULL);
		...
		if (stmt->forecastExpr)
			ereport(ERROR,
					(errcode(ERRCODE_SYNTAX_ERROR),
					 ...
					 scanner_errposition(exprLocation(forecastClause))));
