		   ...
		   EState *estate)
{
	...
	/* UPDATE FORECAST MODELS IN MODELINDEX*/
	MaintenanceEntryPoint(tuple, resultRelationDesc);
	//MaintenanceTest(tuple, resultRelationDesc);

	/* UPDATE ELEMENTARY FORECAST MODELS IN MODELGRAPH */


	if (sdf<5) {
		MaintainModelGraph(tuple, resultRelationDesc);
	}
