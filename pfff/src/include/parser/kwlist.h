...
PG_KEYWORD("attributes", ATTRIBUTES, UNRESERVED_KEYWORD)
PG_KEYWORD("at", AT, UNRESERVED_KEYWORD)
PG_KEYWORD("authorization", AUTHORIZATION, TYPE_FUNC_NAME_KEYWORD)
PG_KEYWORD("average", AVERAGE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("bottomup", BOTTOMUP, RESERVED_KEYWORD)
...
PG_KEYWORD("choose", CHOOSE, RESERVED_KEYWORD)
...
PG_KEYWORD("correlation", CORRELATION, RESERVED_KEYWORD)
...
PG_KEYWORD("decompose", DECOMPOSE, RESERVED_KEYWORD)
...
PG_KEYWORD("disaggregate", DISAGGREGATE, RESERVED_KEYWORD)
PG_KEYWORD("disaggscheme", DISAGGSCHEME, RESERVED_KEYWORD)
...
PG_KEYWORD("fill", FILL, RESERVED_KEYWORD)
PG_KEYWORD("filling", FILLING, UNRESERVED_KEYWORD)
...
PG_KEYWORD("forecast", FORECAST, RESERVED_KEYWORD)
...
PG_KEYWORD("greedy", GREEDY, RESERVED_KEYWORD)
...
PG_KEYWORD("modelgraph", MODELGRAPH, RESERVED_KEYWORD)
PG_KEYWORD("modelindex", MODELINDEX, RESERVED_KEYWORD)
PG_KEYWORD("month", MONTH_P, UNRESERVED_KEYWORD)
PG_KEYWORD("move", MOVE, UNRESERVED_KEYWORD)
PG_KEYWORD("mult", MULT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("number", NUMBER, RESERVED_KEYWORD)
...
PG_KEYWORD("parameters",PARAMETERS,UNRESERVED_KEYWORD)
...
PG_KEYWORD("reestimate", REESTIMATE, RESERVED_KEYWORD)
...
PG_KEYWORD("restore", RESTORE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("season", SEASON, UNRESERVED_KEYWORD)
...
PG_KEYWORD("strategy", STRATEGY, UNRESERVED_KEYWORD)
...
PG_KEYWORD("topdown", TOPDOWN, RESERVED_KEYWORD)
PG_KEYWORD("trailing", TRAILING, RESERVED_KEYWORD)
PG_KEYWORD("training_data", TRAINING_DATA, UNRESERVED_KEYWORD)
