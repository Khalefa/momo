...
extern SingleForecast *make_forecast(Plan *lefttree, Node *forecastExpr, Query **qry);
extern Decompose *make_decompose(Plan *lefttree, Node *forecastExpr);
extern CreateForecastModel *make_create_forecast_model(Plan *lefttree, ModelInfo *model,Node *forecastExpr, Query **qry);
extern Node *make_disAgg(PlannerInfo *root, Plan *lefttree, Node *disAggExpr, Query **qry);
